...
const Hero = () => {
    return (
        ...
        <div className="flex flex-col md:flex-row justify-around items-center h-[90vh] w-full">
          <motion.div
            initial="hidden"
            animate="show"
          ...
          className="md:w-1/2 flex flex-col items-start ps-[13vw]">
            ...
            <h1 className="text-5xl font-bold text-gray-900 mb-4">I'm Jamaldine Basma</h1>
           ...
           <button className="relative inline-flex items-center px-8 py-2 text-md rounded-full shadow-sm text-white border-[#f75023] bg-[#f75023] border-2 focus:outline-none focus:ring-2 focus:ring-offset-2 overflow-hidden group">
            ...
            <div className='text-xl text-[#238083] flex flex-row gap-3'>
            <GrFacebookOption />
            <IoLogoTwitter />
            <FaLinkedinIn />
            <IoLogoGithub />
