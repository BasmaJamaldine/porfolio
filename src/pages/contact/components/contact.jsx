...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const serviceId = 'service_fbiyxcj';
    const templateId = 'template_uv592cf';
    const userId = 'u3t8g58rtB855a5bO';
    ...
    const data = {
      ...
      from_sub: sub,
      to_name: 'Basma', 
      to_email: 'jamaleddinebassmajamaleddine@gmail.com', 
      message: message,
    };
    console.log(data);
  ...
  return (
    <div className="max-w-6xl mx-auto py-12 relative"  data-aos="fade-down">
      ...
      <div className="flex flex-col md:flex-row gap-[13vw] justify-evenly">
        <div className="md:w-1/3 space-y-6">
          <div className="flex items-center gap-4">
            <div className="w-[5vw] h-[10vh] bg-red-100 rounded-full flex items-center justify-center mr-4">
          ...
          <div className="flex items-center gap-4">
            <div className="w-[5vw] h-[10vh] bg-green-100 rounded-full flex items-center justify-center mr-4">
              <Mail className="w-9 h-9 text-green-500" />
            </div>
            <div>
              <h4 className="text-2xl">Email</h4>
              <p className="text-gray-600">Basma@gmail.com</p>
            </div>
          </div>
          <div className="flex items-center gap-4">
            <div className="w-[5vw] h-[10vh] bg-blue-100 rounded-full flex items-center justify-center mr-4">
              <Phone className="w-9 h-9 text-blue-500" />
            </div>
            <div>
              <h4 className="text-2xl">Phone</h4>
              <p className="text-gray-600">+212 640 121 006</p>
            </div>
          </div>
        </div>

        <form className="md:w-2/3 space-y-4 w-[30%] pt-4" ref={form} onSubmit={handleSubmit}>
