  ...
  return (
    ...
    >
      <motion.div
        ...
        whileTap={{ scale: 0.9 }}
        className={`w-20 h-20 ${skill.color} rounded-full flex items-center justify-center mb-4`}
      >
    ...
    return (
      ...
      <div className="absolute bottom-0  right-0 ">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 p">
